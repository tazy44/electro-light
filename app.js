...
function generateRGB(min, max) {
  ...
  //SPECIFIC RGB
  const colors = ["#3495eb", "#f542ad", "f04141", "#80ed8f"];
  if (colorCounter >= colors.length) {
    colorCounter = 0;
  }
  color = hexToRgb(colors[colorCounter++]);
  return color;
}
...
/* ==================== Setup ==================== */
// Duration is a multiplier in the calculateIncrement() function.
...
//     color = 0;
//   }
//   screen.style.backgroundColor = colors[color++];
// };
